...
class _CheckInState extends State<CheckIn>
{
 ...
 @override
  void initState() {
    ...
    super.initState();
    print('Di CheckInScan (ID) : ${widget.idTrip}');
  }
  ...
  Future<void> scanQR() async {
    ...
    try {
      ...
      {
        await tripmod.updateStatusTripEnd('${widget.idTrip}');
        ...
        Navigator.pop(context);
         showDialog(
                 ...
                 content: new Text('Barcode Salah, atau tidak Valid !'),
                 actions: <Widget>[
                 new IconButton(
  ...
  return Scaffold(
      ...
      children: <Widget>[
           Container(
            ...
            children: [
              Text('Silahkan Scan Check Out, Untuk Memulai Trip',
              style: TextStyle(
