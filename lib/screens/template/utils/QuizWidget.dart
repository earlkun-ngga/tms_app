...
class qb1 extends StatefulWidget {
  var textContent;
  ...
  @override
  qb1state createState() => qb1state();
}

// ignore: camel_case_types
class qb1state extends State<qb1> {
  @override
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: widget.onPressed,
...
class qb2 extends StatefulWidget {
  var textContent;
  ...
  @override
  qbstate2 createState() => qbstate2();
}

// ignore: camel_case_types
class qbstate2 extends State<qb2> {
  @override
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: widget.onPressed,
